...
class Pengeluaran extends StatefulWidget {
  ...
  const Pengeluaran({Key? key, this.keuangan}) : super(key: key);
  @override
  PengeluaranState createState() => PengeluaranState();
}
            ...
            children: [
              ...
              Padding(
                ...
                child: Container(
                    ...
                    //   color: Colors.black,
                    // )),
                    child: PilihanTanggal(onDateSelected: _handleDateSelected)),
              ),
              Padding(
                padding: const EdgeInsets.only(
                  top: 10,
